...
function Header() {
  return (
    <div className='fixed top-0 left-0 right-0 z-50 w-full h-[7vw] bg-slate-900'>
      {/* Top Contact Info */}
      ...
      <div className='flex w-[75vw] h-[8vw] bg-white mt-12 rounded-2xl items-center justify-between mx-auto shadow-lg'>
        ...
        <nav className='flex space-x-8 font-secondery items-center justify-center text-[17px]'>
          <a href='#home' className='relative text-slate-900 hover:text-primary transition duration-300 group'>
            Home
            <span className='absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full'></span>
          </a>
          <a href='#about' className='relative text-slate-900 hover:text-primary transition duration-300 group'>
            About
            <span className='absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full'></span>
          </a>
          <a href='#services' className='relative text-slate-900 hover:text-primary transition duration-300 group'>
            Services
            <span className='absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full'></span>
          </a>
          <a href='#contact' className='relative text-slate-900 hover:text-primary transition duration-300 group'>
            Contact
            <span className='absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full'></span>
          </a>
          <Link to="/driver" className='relative text-slate-900 hover:text-primary transition duration-300 group'>
            Become a Driver
            <span className='absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full'></span>
          </Link>
        </nav>
        ...
        <div className='flex items-center gap-6 pr-8'>
          <Link to="/ride">
            <button className='w-52 h-14 flex justify-center items-center rounded-lg font-secondery text-[17px] bg-primary text-white hover:bg-slate-900 hover:text-primary transition duration-300'>
              Let's Ride Now!
            </button>
          </Link>
